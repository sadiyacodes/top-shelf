...
let getColBg = "#f7ecee";
let blobColBg = "#f2e0e2";
//color for please login button lighter brown-red type #F9F0EE
//color darker brown-red type #F4D0C4
          ...
          >
           ...
           <div className="flex flex-col space-y-2 items-start justify-center w-full pr-2">
             ...
             <div className="flex justify-between items-center w-full">
              <span className="text-xs md:text-sm tracking-wider"> Price :₹{price}
              </span>
             </div>
