...
const Register = () => {
    ...
    const handleSubmit = async(event)=>
    {
        ...
        try{
            const sendData = await axios.post(  `${import.meta.env.VITE_BACKEND_API}/api/v1/auth/register`,
  ...
  return (
  <Layout title="Register | Top Shelf">
     <section className='bg-brand py-8 w-full font-ebgm'>
          ...
          <div className="w-full rounded-lg shadow-lg md:mt-0 sm:max-w-md xl:p-0 bg-mid dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full bg-brandred text-mid hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Create an account
                </button>
