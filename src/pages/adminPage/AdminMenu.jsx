  ...
  return (
    <div  className={`flex-col space-y-4 md:w-${width}`}>
      ...
      <div className='flex md:flex-col space-x-3 md:space-x-0 md:space-y-4'>
        ...
        <NavLink
          className="w-1/2 bg-brandred text-mid hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xs md:text-sm px-2 py-2 md:px-5 md:py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 hover:scale-105 transition-all duration-150"
