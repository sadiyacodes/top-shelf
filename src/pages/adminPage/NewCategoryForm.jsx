...
const NewCategoryForm = ({handleSubmit , name, setName, isCreate}) => {
  return (
    ...
    onSubmit={handleSubmit}>
      ...
      type="text"
      name="name"
      className='bg-gray-50 border border-gray-300 text-gray-900 text-sm md:text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-2/3 p-2.5 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500 font-ebgm'
      onChange={(event)=>{
