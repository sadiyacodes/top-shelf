...
const handleUpdateProduct = async(event)=>
{
    ...
    try{
        //creating a form data to get the images - not needed here
  ...
  return (
   <Layout title='Update Product - Top shelf'>
      ...
      <div>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex justify-between w-full items-center md:pr-10 flex-wrap">
              <label className="px-2 py-1 md:px-4 md:py-2 rounded-md shadow-md bg-teal-300 text-gray-800 text-sm md:text-md font-ebgm cursor-pointer">
                {image? 
            ...
            <textarea
             type="text"
             name="description"
             className="w-full rounded-md border-2 px-4 py-4 font-ebgm text-md placeholder:font-ebgm text-gray-800 placeholder:text-gray-400 bg-gray-50 "
            ...
            <input
              ...
              />
               <button
                className="px-2 py-1 md:px-4 md:py-2 bg-brand text-sm md:text-md rounded-md shadow-md text-mid font-ebgm mx-auto"
                type="submit"
