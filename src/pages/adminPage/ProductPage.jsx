...
const ProductPage = () => {
    ...
    const getAllProducts = async() =>{
        try{
            const {data} = await axios.get(   `${import.meta.env.VITE_BACKEND_API}/api/v1/product/products`);
            console.log(data);
            if(data?.success){
               setProducts(()=>{
                ...
                setIsLoading(false);
                    ...
                    console.log("error fetching products at this time , try again")
                }        
           }
        catch(error)
        {
  ...
  return (
    <Layout title="Admin Product Page - Top Shelf">
